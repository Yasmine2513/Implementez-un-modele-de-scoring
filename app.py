...
#Import Data
data = pd.read_csv('df_sample.csv', encoding ='utf-8',errors='ignore')
dataset = pd.read_csv("df_complet_sample.csv",index_col = 0, encoding ='utf-8',errors='ignore')
data_mdl = pd.read_csv(open('df_sample.csv'),index_col =0, encoding ='utf-8',errors='ignore')
description_df = pd.read_csv(open('HomeCredit_columns_description.csv'),index_col ='Row', encoding ='utf-8',errors='ignore')
...
def client():
    ...
    api_url = "https://fastapi-project07-ds-ocr.herokuapp.com/prediction"
